...
4. **Programmable by you**. As stated above, for the Tradenet to remain "trustless" is it important that You.Define.The.Trade.Rules. Why is it crucial for users to program and be able to read the rules of the trade? Like basic literacy, it frees a trader from total dependency on intermediaries and fulfills the trustless principle of  Tradenet. It will allow trade participants to agree on commercial terms and avoid legal action. But will people be able to program? A great web site [IFTTT](https://ifttt.com/) demonstrated that regular people can do it, given the right tools. For the lack of the proper term, we call such programming, a micro-scripted trading (in our startup we playfully call these scripts, tradles).

5. **Self-governed**. Conflict resolution will be based on programmed trade rules, agreed upon upfront. For conflict resolution these programs will use escrow, fidelity bonds and insurance, as opposed to legal actions, in the style of [lex mercatoria](http://bitcoinism.blogspot.ca/2013/12/lex-cryptographia.html). 
