...
4. **Programmable by you**. As stated above, for the Tradenet to remain "trustless" is it important that You.Define.The.Trade.Rules. Why is it so crucial? Like basic literacy, it frees the trader from total dependency on intermediaries and fulfills the trustless principle of  Tradenet. But will people be able to program? A great web site [IFTTT](https://ifttt.com/) demonstrated that regular people can do it, given the right tools. For the lack of the proper term, we call this type of programming micro-scripting (in our startup we playfully call these trading scripts, tradles).
