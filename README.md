...
- **profiles** - this is probably the most powerful way of simplfifying micro-scripting. Like bluetooth profiles this allows to create a domain-specific context. Profile will have their own set of technicals, types of rules, choices of actions, etc. Examples of profiles: algo-trading profile (the only one we have at this point), company formation, funding, b2c, b2b, a legal agreement (smart contract), etc.
