...
New mobile app multi-tier architecture, broad strokes
=====================================================
...
First oracles implementations will be in Java, open sourced in this github repo. It will be designed to run on Android or Oracle Java, so potentially it can run on any OS and even on Android smartphones. Tradles could also be written manually. 
