...
- **models** - models are used pervasively in modern apps (MVC). But rarely models are treated as first class citizens. Over the years our team has developed the methodology of making apps simpler by arranging the code around models, and computations around data changes. I think this is what object-oriented programming was meant to be - look at the world, reflect it in your objects and let your users interact directly with them.
